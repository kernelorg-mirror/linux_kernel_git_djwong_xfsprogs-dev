...
static int		sflag;
static xfs_suminfo_raw_t *sumcompute;
static xfs_suminfo_raw_t *sumfile;
...
{
	xfs_rfsblock_t	bno;
	xfs_suminfo_raw_t *csp;
	xfs_suminfo_raw_t *fsp;
	int		log;
	...
	char		**argv)
{
	...
	if (rt) {
		...
		sumfile = xcalloc(words, sizeof(xfs_suminfo_raw_t));
		sumcompute = xcalloc(words, sizeof(xfs_suminfo_raw_t));
	}
