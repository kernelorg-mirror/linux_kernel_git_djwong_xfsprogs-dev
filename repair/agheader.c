	...
	struct xfs_sb		*sb)
{
	...
	/*
	 * Ignore NEEDSREPAIR discrepancies in the secondary superblocks
	 * because we use it to force admins to run repair, and repair will
	 * clear it from all superblocks before it exits.
	 */
