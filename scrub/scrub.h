...
int scrub_rt_metadata(struct scrub_ctx *ctx, struct scrub_item *sri);
int scrub_quota_metadata(struct scrub_ctx *ctx, struct scrub_item *sri);
int scrub_iscan(struct scrub_ctx *ctx, struct scrub_item *sri);
