	...
	const char		*rtname)
{
	...
	atomicswap_enabled = geo->flags & XFS_FSOP_GEOM_FLAGS_ATOMIC_SWAP ? 1 : 0;

	printf(_(
"meta-data=%-22s isize=%-6d agcount=%u, agsize=%u blks\n"
"         =%-22s sectsz=%-5u attr=%u, projid32bit=%u\n"
"         =%-22s crc=%-8u finobt=%u, sparse=%u, rmapbt=%u\n"
"         =%-22s reflink=%-4u bigtime=%u, atomicswap=%u\n"
...
"realtime =%-22s extsz=%-6d blocks=%lld, rtextents=%lld\n"),
		...
		"", reflink_enabled, bigtime_enabled, atomicswap_enabled,
