...
#define FILE_SWAP_RANGE_FSYNC		(1 << 4)

/* Dry run; do all the parameter verification but do not change anything. */
#define FILE_SWAP_RANGE_DRY_RUN		(1 << 5)

/*
 * Do not swap any part of the range where file1's mapping is a hole.  This
 * can be used to emulate scatter-gather atomic writes with a temp file.
 */
#define FILE_SWAP_RANGE_SKIP_FILE1_HOLES (1 << 6)
 ...
 * SKIP_FILE1_HOLES.
 */
#define FILE_SWAP_RANGE_COMMIT		(FILE_SWAP_RANGE_FILE2_FRESH | \
					 FILE_SWAP_RANGE_FSYNC)
...
#define FILE_SWAP_RANGE_ALL_FLAGS	(FILE_SWAP_RANGE_NONATOMIC | \
					 ...
					 FILE_SWAP_RANGE_FSYNC | \
					 FILE_SWAP_RANGE_DRY_RUN | \
					 FILE_SWAP_RANGE_SKIP_FILE1_HOLES)

#define FISWAPRANGE	_IOWR('X', 129, struct file_swap_range)
#endif /* HAVE_FISWAPRANGE */

/* XXX ugly hacks for new flags */
#ifndef FILE_SWAP_RANGE_DRY_RUN
# define FILE_SWAP_RANGE_DRY_RUN		(1 << 5)
#endif

#ifndef FILE_SWAP_RANGE_SKIP_FILE1_HOLES
# define FILE_SWAP_RANGE_SKIP_FILE1_HOLES (1 << 6)
#endif
