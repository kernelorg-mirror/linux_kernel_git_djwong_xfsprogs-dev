...
/*
 * Caller wishes to defragment the file.  Returns -EOPNOTSUPP if performing the
 * swap would result in more fragmentation.
 */
#define FILE_SWAP_RANGE_DEFRAGMENT	(1 << 4)
