...
#define XFS_ATTRI_OP_FLAGS_PPTR_REMOVE	4	/* Remove parent pointer */
#define XFS_ATTRI_OP_FLAGS_PPTR_SET	5	/* Set parent pointer */
...
struct xfs_attri_log_format {
	...
	/*
	 * For PPTR_REPLACE, this is the length of the new xattr value.
