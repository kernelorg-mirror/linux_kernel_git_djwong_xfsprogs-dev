...
#define XFS_SB_FEAT_INCOMPAT_METADIR	(1 << 31)	/* metadata dir tree */
...
#define XFS_RTRMAP_LEN_MAX		((uint32_t)~0ULL)
...
#define RTRMAPBT_STARTBLOCK_BITLEN	32
#define RTRMAPBT_BLOCKCOUNT_BITLEN	32
 ...
 * staging extents because they're all at the right side of the tree.
 */
#define XFS_RTREFC_COWFLAG		((uint32_t)(1U << 31))
