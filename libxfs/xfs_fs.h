...
#define XFS_FSOP_GEOM_SICK_RT_RMAPBT	(1 << 9)  /* realtime rmapbt */
#define XFS_FSOP_GEOM_SICK_RT_REFCNTBT	(1 << 10) /* realtime refcountbt */
...
#define XFS_FSOP_GEOM_FLAGS_ATOMIC_SWAP	(1 << 31) /* atomic file extent swap */
