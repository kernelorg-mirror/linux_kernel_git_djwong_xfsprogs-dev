...
impl TryFrom<u64> for XfsAgNumber {
    ...
    fn try_from(v: u64) -> Result<Self> {
        if v > i32::MAX as u64 {
            Err(baddata!(M_("AG number too large"), Self, v))
        } else {
...
impl TryFrom<u64> for XfsRgNumber {
    ...
    fn try_from(v: u64) -> Result<Self> {
        if v > i32::MAX as u64 {
            Err(baddata!(M_("rtgroup number too large"), Self, v))
        } else {
...
impl TryFrom<u64> for XfsIno {
    ...
    fn try_from(v: u64) -> Result<Self> {
        if v > i64::MAX as u64 {
            Err(baddata!(M_("inode number too large"), Self, v))
        } else {
            Ok(XfsIno(v))
        }
    }
...
impl TryFrom<u64> for XfsIgeneration {
    ...
    fn try_from(v: u64) -> Result<Self> {
        if v > u32::MAX as u64 {
            Err(baddata!(M_("inode generation number too large"), Self, v))
        } else {
...
impl TryFrom<u64> for XfsPos {
    ...
    fn try_from(v: u64) -> Result<Self> {
        if v > i64::MAX as u64 {
            Err(baddata!(M_("file position too large"), Self, v))
        } else {
            Ok(XfsPos(v))
        }
    }
...
impl TryFrom<u64> for XfsIoLen {
    ...
    fn try_from(v: u64) -> Result<Self> {
        if v > i64::MAX as u64 {
            Err(baddata!(M_("file IO length too large"), Self, v))
        } else {
